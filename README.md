...
- `title` and `members` are required; `icon` and `symbol` are optional and mutually exclusive under the same conflict, size, and catalog-availability rules as command items.
